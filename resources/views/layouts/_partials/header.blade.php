                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="{{ asset('images/user_img.jpg')}}" alt="#"><span class="name_user">Jhon Smith</span></a>
                                    <div class="dropdown-menu">
                                      
                                       <a class="dropdown-item" href="{{ route('admin/settings') }}">Settings</a>
                                       <a class="dropdown-item" href="{{ route('admin/help') }}">Help</a>
